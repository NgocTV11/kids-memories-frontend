...
export const photosTranslations = {
  vi: {
    // Page title
    title: 'Thư Viện Ảnh',
    subtitle: 'Khám phá và quản lý tất cả ảnh',
    ...
    downloadSelected: 'Tải về đã chọn',
    ...
    download: 'Tải về',
    share: 'Chia sẻ',
    setAsAvatar: 'Đặt làm ảnh đại diện',
  ...
  en: {
    // Page title
    title: 'Photo Gallery',
    subtitle: 'Explore and manage all photos',
    ...
    // Messages
    loadError: 'Failed to load photos list',
...
export const getPhotosTranslation = (locale: Locale) => photosTranslations[locale];
