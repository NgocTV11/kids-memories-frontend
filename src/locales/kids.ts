...
export const kidsTranslations = {
  vi: {
    ...
    detail: {
      ...
      ageYears: 'tuổi',
      ageMonths: 'tháng',
      ageFormat: '{years} tuổi {months} tháng',
    },
    
    // Growth modal
    growthModal: {
      title: 'Thêm Dữ Liệu Phát Triển',
      dateLabel: 'Ngày đo',
      heightLabel: 'Chiều cao (cm)',
      ...
      noteLabel: 'Ghi chú',
      notePlaceholder: 'Ghi chú về dữ liệu đo...',
      addButton: 'Thêm',
      cancel: 'Hủy',
      addSuccess: 'Đã thêm dữ liệu phát triển',
      addError: 'Không thể thêm dữ liệu',
    },
  ...
  en: {
    ...
    detail: {
      ...
      genderGirl: 'Girl',
      genderOther: 'Other',
      growthRecords: 'Growth records count',
    ...
    growthModal: {
      ...
      noteLabel: 'Notes',
      notePlaceholder: 'Notes about measurement...',
      addButton: 'Add',
      cancel: 'Cancel',
      addSuccess: 'Growth data added',
  ...
  ja: {
    ...
    detail: {
      ...
      growthChart: '成長チャート',
      addData: 'データを追加',
      noGrowthData: '成長データがまだありません',
      addFirstData: '最初のデータを追加',
      ageYears: '歳',
      ageMonths: 'ヶ月',
      ageFormat: '{years}歳{months}ヶ月',
    },
    ...
    growthModal: {
      ...
      noteLabel: 'メモ',
      notePlaceholder: '測定に関するメモ...',
      addButton: '追加',
      cancel: 'キャンセル',
      addSuccess: '成長データが追加されました',
      addError: 'データの追加に失敗しました',
    },
