...
export default function TakaBanhmiPage() {
  ...
  return (
    <Box sx={{ bgcolor: 'background.default', minHeight: '100vh' }}>
      ...
      <Box id="menu-section" sx={{ bgcolor: 'grey.50', py: { xs: 8, md: 12 } }}>
        <Container maxWidth="lg">
          ...
          >
            {(showAllMenu ? t.menu.items : t.menu.items.slice(0, 4)).map((item, index) => (
          ...
          <Box sx={{ textAlign: 'center', mt: 6 }}>
            ...
            >
              {showAllMenu ? 'Show Less' : t.menu.viewAllMenu}
            </Button>
          </Box>
        </Container>
      </Box>
      ...
      <Box id="order-section" sx={{ bgcolor: 'grey.50', py: { xs: 8, md: 12 } }}>
        <Container maxWidth="lg">
          <Typography variant="h3" align="center" sx={{ fontWeight: 'bold', mb: 2 }}>
            {t.orderAccess.title}
          </Typography>
